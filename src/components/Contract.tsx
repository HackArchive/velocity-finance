...
// // import { SimpleFuture } from "../sway-api";
// import Button from "./Button";
// import { isLocal, contractId } from "../lib.tsx";
// import { useNotification } from "../hooks/useNotification.tsx";
// import { SimpleFutures } from "../swap-api/SimpleFutures.ts";
...
//   useEffect(() => {
//     if (wallet) {
//       const testContract = new SimpleFutures(contractId, wallet);
...
//         const { value } = await contract.functions.get_position().get();
