    ...
    <div className="min-h-screen">
      <div className="px-5 pt-20">
        <div className="relative flex flex-col justify-center items-center h-[85vh] w-full overflow-clip rounded-[40px]">
          ...
          <Link to="/trade/BTCUSD" className="absolute top-[10vh] left-0 gap-2 text-xl opacity-40">
          ...
          <Link to="/trade/BTCUSD" className="absolute top-[10vh] right-0 gap-2 text-xl opacity-40">
          ...
          <Link to="/trade/BTCUSD" className="absolute bottom-[10vh] left-0 gap-2 text-xl opacity-40">
          ...
          <Link to="/trade/BTCUSD" className="absolute bottom-[10vh] right-0 gap-2 text-xl opacity-40">
